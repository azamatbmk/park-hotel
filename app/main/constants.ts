export const aboutImages = [
    { src: '/photos/about1.png',
      alt: 'Парк-отель Дзуарикау — вид на территорию отеля',
    ...
    { src: '/photos/about2.png',
      alt: 'Парк-отель Дзуарикау — отдых среди гор Осетии',
    ...
    { src: '/photos/about3.png',
      alt: 'Парк-отель Дзуарикау — гостиничный комплекс',
    ...
    { src: '/photos/about4.png',
      alt: 'Парк-отель Дзуарикау — природа вокруг отеля',
    ...
    { src: '/photos/about5.png',
      alt: 'Парк-отель Дзуарикау — панорама окрестностей',
    ...
    { src: '/photos/about6.png',
      alt: 'Парк-отель Дзуарикау — вид на горный пейзаж',
