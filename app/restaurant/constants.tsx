...
export const restaurantImages = [
    ...
    { src: '/photos/restaurant3.png', alt: 'Photo 3' },
    { src: '/photos/restaurant4.png', alt: 'Photo 4' },
    { src: '/photos/restaurant5.png', alt: 'Photo 5' },
    { src: '/photos/restaurant6.png', alt: 'Photo 6' }
  ];
