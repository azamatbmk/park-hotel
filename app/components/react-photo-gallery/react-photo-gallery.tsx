                        ...
                        <div className={
                            ...
                            <div className={styles['right-column']}>
                                <div className={
                                    ...
                                    <Item
                                        original={topImageSrc.src}
                                        thumbnail={topImageSrc.src}
                                        width={442}
                                        height={345}
                                        alt="Фото номера"
                                    >
                                ...
                                <div className={styles['bottom-wrapper']}>
                                    <div className={styles['left-bottom-wrapper']}>
                                        <Item
                                            original={leftBottobImageSrc.src}
                                            thumbnail={leftBottobImageSrc.src}
                                            width={213}
                                            height={342}
                                            alt="Фото номера"
                                        >
                                    ...
                                    <div className={
                                        ...
                                        <Item
                                            original={rightBottomImageSrc.src}
                                            thumbnail={rightBottomImageSrc.src}
                                            width={213}
                                            height={342}
                                            alt="Фото номера"
                                        >
