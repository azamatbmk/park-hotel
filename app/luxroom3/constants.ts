...
export const lux3Description: string =
  'Двухкомнатный номер с\u00A0отдельной спальней и\u00A0гостиной — удобный вариант для\u00A0тех, кто\u00A0предпочитает больше пространства. Современный интерьер и\u00A0все\u00A0необходимые удобства обеспечивают комфортное проживание.';